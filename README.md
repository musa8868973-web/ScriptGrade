...
## 4. The 8 Vulnerability Edge-Case Debuggers
...
## 8. Local Environment Setup & Quickstart Guide
...
```bash
git clone https://github.com/<your-org>/scriptgrade-ai.git
cd scriptgrade-ai
```
...
NEXT_PUBLIC_APP_NAME=ScriptGrade AI
```
